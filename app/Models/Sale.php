...
class Sale extends Model
{
    ...
    {
        return $this->belongsTo('App\\Models\\PosSession', 'pos_session_id');
    }
    ...
    public function paymentsUsingThisCredit(): HasMany
    {
        return $this->hasMany('App\\Models\\PosSessionPayment', 'reference_sale_id');
    }
